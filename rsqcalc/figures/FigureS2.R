...
biome=fread("../analyses/percentileaggr2/biome.bi.snv.mean.tab")
...
mlof=fread("../analyses/percentileaggr2/mlof.bi.snv.mean.tab")
...
inpsyght=fread("../analyses/percentileaggr2/inpsyght.bi.snv.mean.tab")
...
tiff(file="~/FigS2.tiff", height=174, width=174, units="mm", res=300)
