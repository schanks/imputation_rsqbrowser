...
#Aggregate
resultsag=aggregate(results[,c("Core_1000G", "Core_HRC", "Core_TOPMed", "OmniExp_1000G","OmniExp_HRC", "OmniExp_TOPMed", "Omni25_1000G", "Omni25_HRC", "Omni25_TOPMed","MEGA_1000G", "MEGA_HRC", "MEGA_TOPMed")],by=list(results$bin), FUN=percent)
